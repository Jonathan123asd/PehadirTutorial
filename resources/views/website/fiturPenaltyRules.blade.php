    ...
    <section>
        ...
        <div class="row g-3">
            <div class="col-12">
                ...
                <ul>
                    <li class="mb-2"><i class="bi bi-dot"></i> Masukkan email dan kata sandi Anda, lalu klik tombol <b>Login</b>.</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Setelah berhasil masuk ke beranda aplikasi, pilih menu <b>Penalty
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    ...
                    <li class="mb-2"><i class="bi bi-dot"></i> Type Penalty: Jenis Pelanggaran Alpa (Tidak Absen), Late (Terlambat Masuk)</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Rate Penalty: Metode perhitungan penalti Fixed amount (jumlah tetap, contoh: Rp10.000), Percentage (persentase dari gaji harian), Based on Costum Days (potongan berdasarkan jumlah        hari tertentu).</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Number of Days: Jumlah hari yang akan dihitung sebagai dasar penalti.</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Start and End Date: Mulai dan berakhirnya tanggal penalti.</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Status: menunjukkan apakah aturan penalti tersebut aktif atau tidak aktif.</li>
