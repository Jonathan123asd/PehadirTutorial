    ...
    <section>
        ...
        <div class="row g-3">
            <div class="col-12">
                ...
                <ul>
                    <li class="mb-2"><i class="bi bi-dot"></i> Setelah berhasil login, Anda akan diarahkan ke dashboard utama dimana Anda
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    <li class="mb-2"><i class="bi bi-dot"></i> Pada sebelah kiri layar klik menu “<b>Report</b>”. Masuk ke menu
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    <li class="mb-2">Pada bagian Filter Periodep, Pilih:</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Cabang (Branch): Contoh: PT. FIRMAN ABADI MOBILE</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Tanggal Awal dan Akhir: Tentukan periode kehadiran yang ingin ditampilkan.
                        Contoh: 01/09/2024 - 30/09/2024</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Status: Pilih status karyawan (opsional)</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Klik tombol "Search" untuk menampilkan data kehadiran berdasarkan filter
                ...
                <ul class="mb-3">
                    ...
                    <li class="mb-2"><i class="bi bi-dot"></i> Employee ID: Nomor identitas unik karyawan.</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Employee Name: Nama lengkap karyawan.</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Kolom Tanggal (01 - 31): Menunjukkan status kehadiran setiap hari dalam
                        periode yang dipilih.</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Hadir (Present)</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Alpha (Tidak hadir tanpa keterangan)</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Klik tombol Export untuk mengunduh laporan ke file Excel atau PDF sesuai
                        kebutuhan</li>
                </ul>
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    <li class="mb-2"><i class="bi bi-dot"></i> Buka file Timesheet Attendance yang berisi laporan kehadiran karyawan.
                    </li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Data pada file ini menunjukkan kehadiran harian karyawan berdasarkan
                        periode waktu tertentu (contoh: <b>2024-08-01 s/d 2024-08-31</b>).</li>
                    <li class="mb-2"><i class="bi bi-dot"></i> Periksa identitas karyawan di kolom awal, seperti <b>Employee ID, Nama,
                        Departemen,</b> dan <b>Jabatan</b>.</li>
                    <li class="mb-2"><i class="bi bi-dot"></i>Setiap kolom tanggal (01–31) berisi kode kehadiran harian:</li>
                    <li class="ms-4">P = Present (Hadir), A = Alpha (Tanpa Keterangan), I = Izin, S = Sakit, C = Cuti, D = Dinas/Disposisi</li>
                    <li class="mb-2"><i class="bi bi-dot"></i>Lihat bagian kanan file untuk rekapitulasi jumlah kehadiran dan ketidakhadiran.</li>
