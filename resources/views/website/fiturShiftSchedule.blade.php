    ...
    <section>
        ...
        <div class="row g-3">
            <div class="col-12">
                ...
                <ul>
                    <li><i class="bi bi-dot"></i> Klik <b>Time Management</b> yang ada di menu sebelah kanan
                    </li>
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    ...
                    <li><i class="bi bi-dot"></i> Branch: Pilih Branch Anda yang telah di tentukkan oleh perusahaan. (Contoh
                        : Sanudin lokasi kerja PT.Firman Abadi Mobile)</li>
                    <li><i class="bi bi-dot"></i> Departement: Pilih Departement Anda yang telah di tentukkan oleh
                        perusahaan. (Contoh: Sanudin bagian Produksi).</li>
                    <li><i class="bi bi-dot"></i> Position: Posisi Anda berkerja (opsional).</li>
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    <li>Note</li>
                    <li><i class="bi bi-dot"></i> Jangan lupa lakukan Branch, Start Date, End Date yang sesuai dengan yang
                        di isi sebelumnya, untuk melihat hasilnya.</li>
                    <li><i class="bi bi-dot"></i> Klik search untuk mencari.</li>
                    <li><i class="bi bi-dot"></i> Sebelum membuat Shift Schedule lakukan terlebih dahulu Schedule Type untuk
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    ...
                    <li><i class="bi bi-dot"></i> No: Nomor/Angka sesuai kebutuhan.</li>
                    <li><i class="bi bi-dot"></i> Employee ID: Nomor identitas unik karyawan (contoh : SAFNO > 3214675900).
                    </li>
                    <li><i class="bi bi-dot"></i> Name: Nama karyawan.</li>
                    <li><i class="bi bi-dot"></i> Date: Tanggal Shift.</li>
            ...
            <div class="col-12">
                ...
                <ul class="mb-2">
                    <li><i class="bi bi-dot"></i> Setelah semunya selesai terisi.</li>
            ...
            <div class="col-12">
                ...
                <ul class="mb-3">
                    <li>Note</li>
                    <li><i class="bi bi-dot"></i> Employee id = bisa di dapat di menu karyawan</li>
                    <li><i class="bi bi-dot"></i> name =  nama karyawan</li>
                    <li><i class="bi bi-dot"></i> date = tanggal shift</li>
                    <li><i class="bi bi-dot"></i> schedule = nama shift bisa di dapat di menu schedule type</li>
                    <li><i class="bi bi-dot"></i> branch code = bisa di dapat di menu settings > master data > branch</li>
                    <li><i class="bi bi-dot"></i> Jika di bagian employee id tidak bisa menambahkan angka 0</li>
                    <li><i class="bi bi-dot"></i> 1. Klik sel tempat angka itu berada, 2. Klik kanan → pilih Format Cells, 3. Pilih Text → klik OK</li>
                </ul>
            </div>
        </div>
        {{-- /Page Content --}}
