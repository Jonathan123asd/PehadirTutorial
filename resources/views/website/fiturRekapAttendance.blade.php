...
@section('content')
    <section>
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Cara Menggunakan Fitur Rekap Attendance pada Website Pehadir</h3>
                    <ul class="breadcrumb">
        ...
        <div class="row g-4">
            <div class="col-12">
                ...
                <img class="img-custom-dekstop w-100" src="{{ asset('assets/img/website/fiturRekapAttendance/1.png') }}"
            ...
            <div class="col-12">
                ...
                <img class="img-custom-dekstop w-100" src="{{ asset('assets/img/website/fiturRekapAttendance/2.png') }}"
            ...
            <div class="col-12">
                ...
                <img class="img-custom-dekstop w-100" src="{{ asset('assets/img/website/fiturRekapAttendance/3.png') }}"
            ...
            <div class="col-12">
                ...
                <img class="img-custom-dekstop w-100" src="{{ asset('assets/img/website/fiturRekapAttendance/4.png') }}"
            ...
            <div class="col-12">
                ...
                <img class="img-custom-dekstop w-100" src="{{ asset('assets/img/website/fiturRekapAttendance/5.png') }}"
    ...
    <img class="img-custom-dekstop w-100 mb-3" src="{{ asset('assets/img/website/fiturRekapAttendance/6.png') }}"
